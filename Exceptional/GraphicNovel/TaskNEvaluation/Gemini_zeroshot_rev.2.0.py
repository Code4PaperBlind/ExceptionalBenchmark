...
#            prompt_images.append(prompt_image)
        ...
        combined_input = [prompt, prompt_images[0], prompt_images[1], prompt_images[2], prompt_images[3]]
...
# save csv file
df.to_csv('your_directory/Zeroshot.csv', index=False)
print("done")
